...
const projectList = [
  { name: "SusJobs", category: "major", tags: ["Python","Flask","Javascript","Gemini AI","NLP","Naive Bayes"], desc: "An AI-powered Fake Job Detector that classifies job posts and explains fraud risks all from a single description.", image: susJobsImg,github:"https://github.com/Shushmitaaaa/SusJobs.git",website:"susjobs-3.onrender.com"},
  ...
  { name: "MovieHunt", category: "major", tags: ["React.js", "JavaScript","Tailwind CSS","TMDB API"], desc: "A movie search app which helps in searching for a specific movies based on some filters.", image: moviehuntImg,github:"https://github.com/Shushmitaaaa/MovieHunt.git",website:"movie-hunt-ksh2.vercel.app/" },
